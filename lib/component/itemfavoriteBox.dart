...
class ItemFavoriteBox extends StatefulWidget {
  final int index;
  final int categoryIndex;
  const ItemFavoriteBox({
    super.key,
    required this.index,
  ...
  @override
  State<ItemFavoriteBox> createState() => _ItemFavoriteBoxState();
}

class _ItemFavoriteBoxState extends State<ItemFavoriteBox> {
